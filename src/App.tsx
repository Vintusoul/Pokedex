      ...
      <div className="bg-gray-800 w-full flex justify-center border-cyan-50">
        <div className=" w-11/12 input-group relative flex items-stretch mb-4 rounded">
          <input
            id="searchInput"
            type="search"
            className=" font-pokemon form-control relative flex-auto autofill:bg-yellow-200 min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-800 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
